...
ROI_CROP_TOP = 100  # 100 chaff  # 44 epoch/dave2  # int(IMAGE_H * 0.4)                   #the number of rows of pixels to ignore on the top of the image
# ROI_CROP_BOTTOM = 0                 #the number of rows of pixels to ignore on the bottom of the image
#
# #CAMERA
CAMERA_TYPE = "CSIC"  # (PICAM|WEBCAM|CVCAM|CSIC|V4L|D435|MOCK|IMAGE_LIST)
IMAGE_W = 320  # dave2 200 normal 320
IMAGE_H = 240  # dave2 110 normal 240
# IMAGE_DEPTH = 3         # default RGB=3, make 1 for mono
# CAMERA_FRAMERATE = DRIVE_LOOP_HZ
# CAMERA_VFLIP = False
# CAMERA_HFLIP = False

# # ENABLE CORRUPTIONS BY HENDRYCKS'
USE_CORRUPTED_INPUTS = False
CORRUPTION = "pixelate"
SEVERITY = 5
CORRUPTION_DELAY = 0  # how many seconds before the corruption is activated

# # ENABLE ADVERSARIAL DRIVING
USE_ADVERSARIAL_DRIVING = False
ADV_IMAGE = "chauffeur-sim-perturbation_noright.pickle"
...
STEERING_LEFT_PWM = 480  # pwm value for full left steering (DEFAULT: 460)
STEERING_RIGHT_PWM = 280  # pwm value for full right steering (DEFAULT: 290)
# steering_middle = 380
# 
...
MAX_EPOCHS = 1000  # how many times to visit all records of your data
# SHOW_PLOT = True                #would you like to see a pop up display of final loss?
# VERBOSE_TRAIN = True             #would you like to see a progress bar with text during training?
# USE_EARLY_STOP = True           #would you like to stop the training if we see it's not improving fit?
EARLY_STOP_PATIENCE = 30  # how many epochs to wait before no improvement
# MIN_DELTA = .0005               #early stop will want this much loss change before calling it improved.
# PRINT_MODEL_SUMMARY = True      #print layers and weights to stdout
OPTIMIZER = "adam"  # adam, sgd, rmsprop, etc.. None accepts default
LEARNING_RATE = 0.00001  # only used when OPTIMIZER specified
# LEARNING_RATE_DECAY = 0.0       #only used when OPTIMIZER specified
# SEND_BEST_MODEL_TO_PI = False   #change to true to automatically send best model during training
# CACHE_IMAGES = True             #keep images_real in memory. will speed succesive epochs, but crater if not enough mem.
# 
...
# PI_USERNAME = "jetsonnano"                  # username on pi
...
# 
# #For the categorical model, this limitfs the upper bound of the learned throttle
# #it's very IMPORTANT that this value is matched from the training PC config.py and the robot.py
# #and ideally wouldn't change once set.
# MODEL_CATEGORICAL_MAX_THROTTLE_RANGE = 0.5
# 
# #RNN or 3D
# SEQUENCE_LENGTH = 3             #some models use a number of images_real over time. This controls how many.
# 
# #IMU
...
carname = ""
GYM_CONF = {"body_style": "donkey", "body_rgb": (128, 128, 128), "car_name": carname,
            "font_size": 100}  # body style(donkey|bare|car01) body rgb 0-255
GYM_CONF["racer_name"] = ""
GYM_CONF["country"] = ""
GYM_CONF["bio"] = ""
# 
