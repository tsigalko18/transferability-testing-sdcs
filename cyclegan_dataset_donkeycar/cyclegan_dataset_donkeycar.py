...
_DL_URL = ""  # URL to data here

_DATA_OPTIONS = ["cyclegan_dataset_donkeycar"]
# _DL_URLS = _DL_URL + "data.zip"
_DL_URLS = _DL_URL + "data_v3.zip"
...
class CycleGAN(tfds.core.GeneratorBasedBuilder):
    ...
    def _info(self):
        return tfds.core.DatasetInfo(
            builder=self,
            description="A dataset consisting of driving images from two classes A and B",
