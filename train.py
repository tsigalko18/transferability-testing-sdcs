            ...
            for key in keys:
                ...
                if len(batch_data) == batch_size:
                    ...
                    for record in batch_data:
                        ...
                        # if model_type == DAVE2:  # or model_type == DAVE2_MC:
...
def go_train(kl, cfg, train_gen, val_gen, gen_records, model_name, steps_per_epoch, val_steps, continuous, verbose,
             save_best=None):
    start = time.time()
...
def extract_data_from_pickles(cfg, tubs):
    ...
    for tub_path in t_paths:
        ...
        print('found {} pickles writing json records and images_real in tub320x240_train {}'.format(len(file_paths),
                                                                                                    tub_path))
